...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: batman-cavaleirodastrevas.php?msg=enviado");
        exit();
    } else {
...
<head>
    ...
    <title>Batman - Cavaleiro das Trevas</title>
</head>
<body>
    <header class="header">
        <nav class="nav">
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-batman.jpg" alt="Batman - Cavaleiro das Trevas">
            <img class="poster" src="../assets/poster-batman.jpg" alt="Batman - Cavaleiro das Trevas">
            <div class="descricao-filme">
                <h2>Batman - Cavaleiro das Trevas (2008)</h2>
                <p class="genero"><b>Gênero:</b> Ação / Crime</p>
                <p>Batman enfrenta o caos imposto pelo Coringa, que testa os limites da moralidade. O filme discute justiça, sacrifício e a linha tênue entre ordem e desordem.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 35 ORDER BY id DESC");
