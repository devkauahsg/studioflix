...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: o-grande-gatsby.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-grande-gatsby.jpg" alt="O Grande Gatsby ">
            <img class="poster" src="../assets/poster-gatsby.jpg" alt="O Grande Gatsby ">
            <div class="descricao-filme">
                <h2>O Grande Gatsby (2013)</h2>
                <p class="genero"><b>Gênero:</b> Drama</p>
                <p>Nick Carraway narra sua experiência com Jay Gatsby, um milionário misterioso e apaixonado por Daisy. O filme explora ilusão, riqueza, amor obsessivo e decadência da elite.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 31 ORDER BY id DESC");
