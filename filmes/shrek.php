...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: shrek.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-shrek.jpg" alt="Shrek">
            <img class="poster" src="../assets/poster-shrek.jpg" alt="Shrek">
            <div class="descricao-filme">
                <h2>Shrek (2001)</h2>
                <p class="genero"><b>Gênero:</b> Animação</p>
                <p>Shrek só quer paz em seu pântano, mas precisa salvar uma princesa para recuperar seu lar. Ele descobre amizade, amor e que beleza não segue padrões. Uma sátira inteligente dos contos de fadas.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 51 ORDER BY id DESC");
