...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: clube-dos-cinco.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-clube-dos-cinco.jpg" alt="Clube dos Cinco">
            <img class="poster" src="../assets/poster-clube-dos-cinco.jpg" alt="Clube dos Cinco">
            <div class="descricao-filme">
                <h2>Clube dos Cinco (1985)</h2>
                <p class="genero"><b>Gênero:</b> Drama / Teen</p>
                <p>Cinco adolescentes de estereótipos diferentes cumprem detenção juntos e descobrem que compartilham inseguranças e dores. O filme fala sobre identidade, pressão social e empatia.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 28 ORDER BY id DESC");
