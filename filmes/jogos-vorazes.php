...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: jogos-vorazes.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-jogos-vorazes.jpg" alt="Jogos Vorazes">
            <img class="poster" src="../assets/poster-jogos-vorazes.jpg" alt="Jogos Vorazes">
            <div class="descricao-filme">
                <h2>Jogos Vorazes (2012)</h2>
                <p class="genero"><b>Gênero:</b> Distopia / Ação</p>
                <p>Katniss se voluntaria para proteger a irmã e é forçada a lutar pela sobrevivência em um reality mortal. A história critica regimes autoritários, espetáculo e resistência.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 41 ORDER BY id DESC");
