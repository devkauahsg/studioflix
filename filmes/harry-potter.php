...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: harry-potter.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-harry-potter.jpg" alt="Harry Potter e a Pedra Filosofal">
            <img class="poster" src="../assets/poster-harrypotter.jpg" alt="Harry Potter e a Pedra Filosofal">
            <div class="descricao-filme">
                <h2>Harry Potter e a Pedra Filosofal (2001)</h2>
                <p class="genero"><b>Gênero:</b> Fantasia</p>
                <p>Harry descobre que é bruxo e entra em Hogwarts, onde aprende magia, faz amigos e enfrenta perigos ao investigar uma pedra mágica que dá imortalidade. O filme aborda amizade, coragem e a descoberta do próprio valor.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 14 ORDER BY id DESC");
