...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: superman.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-superman.jpg" alt="Superman">
            <img class="poster" src="../assets/poster-superman.jpg" alt="Superman">
            <div class="descricao-filme">
                <h2>Superman (2025)</h2>
                <p class="genero"><b>Gênero:</b> Super-herói</p>
                <p>Clark Kent (David Corenswet) tenta conciliar sua herança kryptoniana com a vida humana em Smallville. Quando surge uma crise internacional, ele enfrenta o vilão Lex Luthor (Nicholas Hoult) e deve provar que seus valores de justiça ainda fazem sentido para a humanidade. No caminho, conta com aliados como Lois Lane e seu fiel super-cão Krypto..</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 39 ORDER BY id DESC");
