...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: interestelar.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-interestelar.jpg" alt="Interestelar">
            <img class="poster" src="../assets/poster-interestelar.jpg" alt="Interestelar">
            <div class="descricao-filme">
                <h2>Interestelar (2014)</h2>
                <p class="genero"><b>Gênero:</b> Ficção Científica / Drama</p>
                <p>Em um futuro em que a Terra se torna inabitável, um grupo de astronautas parte em busca de um novo lar para a humanidade. A missão é guiada por Cooper, que deixa sua filha, iniciando uma jornada que mistura ciência, emoção e o mistério do tempo. O filme une conceitos complexos de física com uma história sobre amor e esperança, mostrando que a conexão humana pode transcender distâncias, décadas e até dimensões.
                Curiosidade: As simulações de buracos negros foram tão precisas que geraram pesquisas científicas reais.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 5 ORDER BY id DESC");
