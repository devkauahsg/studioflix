...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: clube-da-luta.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-clube-da-luta.jpg" alt="Clube da Luta">
            <img class="poster" src="../assets/poster-clubedaluta.jpeg" alt="Clube da Luta">
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 6 ORDER BY id DESC");
