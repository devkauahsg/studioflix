...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: os-incriveis.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-os-incriveis.jpg" alt="Os Incríveis ">
            <img class="poster" src="../assets/poster-incriveis.jpg" alt="Os Incríveis ">
            <div class="descricao-filme">
                <h2>Os Incríveis (2004)</h2>
                <p class="genero"><b>Gênero:</b> Animação / Super-herói</p>
                <p>A família Parr, composta por super-heróis, tenta viver uma vida comum após os heróis serem proibidos. Quando um vilão ameaça o mundo, eles precisam se unir e aceitar quem realmente são. A história explora família, identidade e trabalho em equipe..</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 21 ORDER BY id DESC");
