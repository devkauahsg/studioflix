...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: o-show-truman.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-show-de-truman.jpg" alt="O Show de Truman ">
            <img class="poster" src="../assets/poster-show-truman.jpg" alt="O Show de Truman ">
            <div class="descricao-filme">
                <h2>O Show de Truman (1998)</h2>
                <p class="genero"><b>Gênero:</b> Drama / Ficção científica</p>
                <p>Truman vive em um reality show sem saber. Após perceber inconsistências no mundo, busca descobrir a verdade e conquistar sua liberdade. O filme discute manipulação e livre-arbítrio.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 40 ORDER BY id DESC");
