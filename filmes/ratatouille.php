...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: ratatouille.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-ratatouille.jpg" alt="Ratatouille">
            <img class="poster" src="../assets/poster-ratatouille.jpg" alt="Ratatouille">
            <div class="descricao-filme">
                <h2>Ratatouille (2007)</h2>
                <p class="genero"><b>Gênero:</b> Animação</p>
                <p>Remy, um rato com talento para cozinhar, se une ao desajeitado Linguini para se tornar chef. O filme fala sobre arte, talento, preconceito e superação.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 38 ORDER BY id DESC");
