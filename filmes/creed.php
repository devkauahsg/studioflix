...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: creed.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-creed.jpg" alt="Creed">
            <img class="poster" src="../assets/poster-creed.jpg" alt="Creed">
            <div class="descricao-filme">
                <h2>Creed - Nascido para Lutar (2015)</h2>
                <p class="genero"><b>Gênero:</b> Drama / Esporte</p>
                <p>Adonis, filho de Apollo Creed, busca provar seu valor no boxe, mesmo carregando o peso do nome famoso. Ele encontra em Rocky Balboa um mentor e figura paterna. O filme fala sobre identidade, disciplina e redenção.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 19 ORDER BY id DESC");
