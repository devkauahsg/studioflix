...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: a-procura-da-felicidade.php?msg=enviado");
        exit();
    } else {
...
<head>
    ...
    <title>A Procura da Felicidade</title>
</head>
<body>
    <header class="header">
        <nav class="nav">
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-a-procura-da-felicidade.jpg" alt="A Procura da Felicidade">
            <img class="poster" src="../assets/poster-aprocuradafelicidade.jpg" alt="A Procura da Felicidade">
            <div class="descricao-filme">
                <h2>À Procura da Felicdade (2006)</h2>
                <p class="genero"><b>Gênero:</b> Drama</p>
                <p>Chris Gardner enfrenta miséria, abandono e dificuldades extremas enquanto luta para oferecer um futuro ao filho. É uma história real sobre determinação e esperança.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 47 ORDER BY id DESC");
