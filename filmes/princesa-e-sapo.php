...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: princesa-e-sapo.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-princesa-e-sapo.jpeg" alt="A Princesa e o Sapo">
            <img class="poster" src="../assets/poster-princesa-e-o-sapo.jpg" alt="A Princesa e o Sapo">
            <div class="descricao-filme">
                <h2>A Princesa e o Sapo (2009)</h2>
                <p class="genero"><b>Gênero:</b> Animação</p>
                <p>Tiana sonha em abrir seu restaurante, mas após virar sapo, embarca numa aventura cheia de magia e autoconhecimento. O filme valoriza esforço e perseverança.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 45 ORDER BY id DESC");
