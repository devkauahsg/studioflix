...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: carros.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-carros.jpg" alt="Carros">
            <img class="poster" src="../assets/poster-carros.jpg" alt="Carros">
            <div class="descricao-filme">
                <h2>Carros (2006)</h2>
                <p class="genero"><b>Gênero:</b> Animação</p>
                <p>Relâmpago McQueen se perde em uma cidade pequena, onde descobre valores como amizade, humildade e comunidade. A mudança do protagonista mostra a importância de desacelerar e aprender com o outro.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 27 ORDER BY id DESC");
