...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: o-estranho-mundo-de-jack.php?msg=enviado");
        exit();
    } else {
...
<head>
    ...
    <title>O Estranho Mundo de Jack</title>
</head>
<body>
    <header class="header">
        <nav class="nav">
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-o-estranho-mundo-de-jack.jpg" alt="O Estranho Mundo de Jack ">
            <img class="poster" src="../assets/poster-estranho-mundo-jack.jpg" alt="O Estranho Mundo de Jack ">
            <div class="descricao-filme">
                <h2>O Estranho Mundo de Jack (1993)</h2>
                <p class="genero"><b>Gênero:</b> Animação / Fantasia</p>
                <p>Jack, cansado da rotina do Halloween, tenta trazer o Natal para sua cidade e causa confusão. É um conto sobre identidade, propósito e aceitação de si mesmo.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 50 ORDER BY id DESC");
