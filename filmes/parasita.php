...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: parasita.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-parasita.jpg" alt="Parasita">
            <img class="poster" src="../assets/poster-parasita.jpg" alt="Parasita">
            <div class="descricao-filme">
                <h2>Parasita (2019)</h2>
                <p class="genero"><b>Gênero:</b> Suspense / Dram</p>
                <p>Uma família pobre infiltra-se na casa de uma família rica, gerando uma relação simbiótica que se torna sombria. O filme explora desigualdade, luta de classes e manipulação.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 33 ORDER BY id DESC");
