...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: wall-e.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-wall-e.jpg" alt="Wall-E">
            <img class="poster" src="../assets/poster-wall-e.jpg" alt="Wall-E">
            <div class="descricao-filme">
                <h2>Wall-E (2008)</h2>
                <p class="genero"><b>Gênero:</b> Animação</p>
                <p>WALL·E limpa a Terra abandonada até encontrar EVA, que o leva ao espaço. A aventura aborda consumismo, preservação ambiental e amor inocente entre robôs.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 37 ORDER BY id DESC");
