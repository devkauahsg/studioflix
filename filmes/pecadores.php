...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: pecadores.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-pecadores.jpg" alt="Pecadores">
            <img class="poster" src="../assets/poster-pecadores.jpg" alt="Pecadores">
            <div class="descricao-filme">
                <h2>Pecadores (2025)</h2>
                <p class="genero"><b>Gênero:</b> Ficção científica / Suspense</p>
                <p>Um grupo de adolescentes com vidas aparentemente comuns se envolve em situações que fogem do controle após um ato impulsivo. A partir disso, segredos começam a surgir, ameaçando amizades e famílias. O filme destaca como escolhas impensadas podem gerar consequências devastadoras e como a culpa corrói a mente.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 10 ORDER BY id DESC");
