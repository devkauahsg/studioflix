...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: pantera-negra.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-pantera-negra.jpg" alt="Pantera Negra ">
            <img class="poster" src="../assets/poster-pantera-negra.jpg" alt="Pantera Negra ">
            <div class="descricao-filme">
                <h2>Pantera Negra (2018)</h2>
                <p class="genero"><b>Gênero:</b> Super-herói</p>
                <p>Após a morte do pai, T’Challa assume o trono de Wakanda. Ele precisa equilibrar tradição, tecnologia e identidade cultural ao enfrentar Killmonger, um rival com ideais distintos. O filme discute legado, justiça e o impacto social do poder.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 17 ORDER BY id DESC");
