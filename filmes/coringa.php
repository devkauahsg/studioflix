...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: coringa.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-coringa.jpg" alt="Coringa">
            <img class="poster" src="../assets/poster-coringaa.jpg" alt="Coringa">
            <div class="descricao-filme">
                <h2>Coringa (2019)</h2>
                <p class="genero"><b>Gênero:</b> Drama</p>
                <p>Arthur Fleck, um comediante fracassado com problemas mentais, vive isolado em uma sociedade que o rejeita. Após sucessivas humilhações e traumas, ele mergulha em uma espiral de violência e assume a identidade do Coringa. O filme explora saúde mental, desigualdade social e o impacto da negligência em indivíduos vulneráveis.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 11 ORDER BY id DESC");
