...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: gladiador.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-gladiador.jpg" alt="Gladiador">
            <img class="poster" src="../assets/poster-gladiador.jpg" alt="Gladiador">
            <div class="descricao-filme">
                <h2>Gladiador (2000)</h2>
                <p class="genero"><b>Gênero:</b> Ação / Drama</p>
                <p>Maximus, um general romano honrado, é traído e vê sua família ser assassinada. Reduzido à escravidão, ele se torna gladiador e conquista fama nas arenas, buscando vingança contra o imperador corrupto. O filme mostra lealdade, honra, sacrifício e o contraste entre poder e moralidade.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 13 ORDER BY id DESC");
