...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: homem-aranha.php?msg=enviado");
        exit();
    } else {
...
<head>
    ...
    <title>Homem Aranha - Sem Volta pra Casa</title>
</head>
<body>
    <header class="header">
        <nav class="nav">
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-homem-aranha.jpg" alt="Homem Aranha - Sem Volta pra Casa">
            <img class="poster" src="../assets/poster-homemaranha.jpeg" alt="Homem Aranha - Sem Volta pra Casa">
            <div class="descricao-filme">
                <h2>Homem Aranha - Sem Volta pra Casa (2021)</h2>
                <p class="genero"><b>Gênero:</b> Ação / Super-herói</p>
                <p>Após ter sua identidade revelada, Peter Parker pede a ajuda de Doutor Estranho, mas um feitiço errado traz vilões de outros universos. Ele precisa lidar com antigas ameaças, perdas dolorosas e escolhas maduras que moldam sua identidade como herói. A união dos três Homens-Aranha traz emoção e nostalgia.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 12 ORDER BY id DESC");
