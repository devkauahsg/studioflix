...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: homem-de-ferro.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-homem-de-ferro.jpg" alt="Homem de Ferro">
            <img class="poster" src="../assets/poster-homem-de-ferro.jpg" alt="Homem de Ferro">
            <div class="descricao-filme">
                <h2>Homem de Ferro (2008)</h2>
                <p class="genero"><b>Gênero:</b> Super-herói</p>
                <p>Tony Stark, sequestrado, cria uma armadura para escapar e passa a usá-la como herói. Ele enfrenta seu passado e assume responsabilidade sobre o mundo que ajudou a armar.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 34 ORDER BY id DESC");
