...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: need-for-speed.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-need-for-speed.jpeg" alt="Need for Speed">
            <img class="poster" src="../assets/poster-need-for-speed.jpg" alt="Need for Speed">
            <div class="descricao-filme">
                <h2>Need For Speed (2014)</h2>
                <p class="genero"><b>Gênero:</b> Ação / Corrida</p>
                <p>Tobey Marshall participa de uma corrida clandestina para se vingar de um rival que o incriminou. O filme tem adrenalina, camaradagem e corridas reais sem efeitos digitais.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 42 ORDER BY id DESC");
