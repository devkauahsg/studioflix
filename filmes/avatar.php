...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: avatar.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-avatar.jpg" alt="Avatar">
            <img class="poster" src="../assets/poster-avatar.jpg" alt="Avatar">
            <div class="descricao-filme">
                <h2>Avatar (2009)</h2>
                <p class="genero"><b>Gênero:</b> Ficção Científica / Ação</p>
                <p>Jake Sully, um ex-fuzileiro paraplégico, vai ao planeta Pandora para controlar um avatar e ajudar humanos a explorar um mineral valioso. Ao conhecer os Na’vi e se aproximar de Neytiri, ele percebe a destruição causada pelos humanos e muda de lado. Jake então lidera os Na’vi para defender seu planeta em uma grande batalha pela sobrevivência.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 22 ORDER BY id DESC");
