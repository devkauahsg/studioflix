...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: o-pianista.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-o-pianista.jpg" alt="O Pianista ">
            <img class="poster" src="../assets/poster-pianista.jpg" alt="O Pianista ">
            <div class="descricao-filme">
                <h2>O Pianista (2002)</h2>
                <p class="genero"><b>Gênero:</b> Drama / Guerra</p>
                <p>Wladyslaw Szpilman, pianista judeu, luta para sobreviver à ocupação nazista enquanto usa a música como escape emocional. O filme é comovente, realista e profundamente humano.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 26 ORDER BY id DESC");
