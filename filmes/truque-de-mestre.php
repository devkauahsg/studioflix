...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: truque-de-mestre.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-truquedemestre.jpg" alt="Truque de Mestre">
            <img class="poster" src="../assets/poster-truque-de-mestre.jpg" alt="Truque de Mestre">
            <div class="descricao-filme">
                <h2>Truque de Mestre (2013)</h2>
                <p class="genero"><b>Gênero:</b> Suspense / Mistério</p>
                <p>Os Quatro Cavaleiros são ilusionistas que realizam roubos milionários ao vivo nos palcos, desafiando autoridades e deixando o público surpreso. A trama envolve manipulação, ilusionismo real e um grande mistério por trás dos truques..</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 18 ORDER BY id DESC");
