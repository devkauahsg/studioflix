...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: rocky.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-rocky.jpg" alt="Rocky">
            <img class="poster" src="../assets/poster-rocky.jpg" alt="Rocky">
            <div class="descricao-filme">
                <h2>Rocky (1976)</h2>
                <p class="genero"><b>Gênero:</b> Drama / Esporte</p>
                <p>Rocky Balboa, lutador desconhecido, tem a chance de enfrentar o campeão mundial. Seu objetivo não é vencer, mas provar para si mesmo que é digno de respeito. Uma história sobre perseverança, esforço e coração.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 20 ORDER BY id DESC");
