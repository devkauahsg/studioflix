...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: coach-carter.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-coach-carter.jpg" alt="Coach Carter">
            <img class="poster" src="../assets/poster-coach-carter.jpg" alt="Coach Carter">
            <div class="descricao-filme">
                <h2>Coach Carter (2005)</h2>
                <p class="genero"><b>Gênero:</b> Drama / Esporte</p>
                <p>O treinador Ken Carter impõe regras rígidas ao time de basquete, priorizando estudo e disciplina. Ele luta contra o sistema e inspira jovens a buscar um futuro melhor. É um filme sobre educação, respeito e transformação social.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 23 ORDER BY id DESC");
