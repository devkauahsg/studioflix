...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: velozesefuriosos.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-velozesefuriosos.jpg" alt="Velozes e Furiosos">
            <img class="poster" src="../assets/poster-velozes-furiosos.jpg" alt="Velozes e Furiosos">
            <div class="descricao-filme">
                <h2>Velozes e Furiosos (2001)</h2>
                <p class="genero"><b>Gênero:</b> Ação</p>
                <p>Brian O’Conner, policial infiltrado, se junta ao grupo de Dominic Toretto para investigar roubos nas estradas. Ele se aproxima da equipe e questiona sua lealdade. O filme combina ação, corridas, adrenalina e temas de família e confiança.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 15 ORDER BY id DESC");
