...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: rei-leao.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-reileao.jpg" alt="Rei Leão">
            <img class="poster" src="../assets/poster-reileao.jpg" alt="Rei Leão">
            <div class="descricao-filme">
                <h2>Rei Leão (1994)</h2>
                <p class="genero"><b>Gênero:</b> Animação / Drama</p>
                <p>Simba foge após a morte de seu pai, acreditando ser culpado. Anos depois, precisa enfrentar seus medos, voltar para casa e assumir seu destino como rei. A história é uma metáfora sobre amadurecimento, responsabilidade e superação.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 16 ORDER BY id DESC");
