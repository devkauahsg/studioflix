...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: o-lobo-de-wall-street.php?msg=enviado");
        exit();
    } else {
...
<head>
    ...
    <title>O Lobo de Wall Street</title>
</head>
<body>
    <header class="header">
        <nav class="nav">
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-o-lobo-de-wall-street.jpg" alt="O Lobo de Wall Street ">
            <img class="poster" src="../assets/poster-lobo-wall-street.jpg" alt="O Lobo de Wall Street ">
            <div class="descricao-filme">
                <h2>O Lobo de Wall Street (2013)</h2>
                <p class="genero"><b>Gênero:</b> Biografia / Crime</p>
                <p>Jordan Belfort ascende no mercado financeiro usando fraudes, drogas e manipulação. O filme mostra os excessos do capitalismo e a destruição causada pelo poder sem limites.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 29 ORDER BY id DESC");
