...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: crepusculo.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-crepusculo.jpg" alt="Crepusculo">
            <img class="poster" src="../assets/poster-crepusculo.jpg" alt="Crepusculo">
            <div class="descricao-filme">
                <h2>Crepúsculo (2008)</h2>
                <p class="genero"><b>Gênero:</b> Romance / Fantasia</p>
                <p>Bella se apaixona por Edward, um vampiro que luta contra seus instintos para protegê-la. O romance aborda desejo, perigo e amor proibido.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 36 ORDER BY id DESC");
