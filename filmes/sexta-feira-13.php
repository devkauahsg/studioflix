...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: sexta-feira-13.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-sexta-feira.jpg" alt="Sexta Feira 13">
            <img class="poster" src="../assets/poster-sexta-feira.jpg" alt="Sexta Feira 13">
            <div class="descricao-filme">
                <h2>Sexta-Feira 13 (1980)</h2>
                <p class="genero"><b>Gênero:</b> Terror</p>
                <p>Um grupo de jovens reabre um acampamento marcado por tragédias e passa a ser perseguido por um assassino. É o início de uma das maiores franquias do terror slasher.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 25 ORDER BY id DESC");
