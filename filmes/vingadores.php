...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: vingadores.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-vingadoress.jpg" alt="Vingadores">
            <img class="poster" src="../assets/poster-vingadores.jpg" alt="Vingadores">
            <div class="descricao-filme">
                <h2>Vingadores Ultimato (2019)</h2>
                <p class="genero"><b>Gênero:</b> Ação</p>
                <p>Vingadores Ultimato mostra os heróis tentando reverter o estalo de Thanos.
                Eles viajam no tempo para recuperar as Joias do Infinito e trazer todos de volta.
                Isso leva a uma batalha final gigantesca contra Thanos e a um grande sacrifício que salva o universo.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 1 ORDER BY id DESC");
