...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: toy-story.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-toy-story.jpg" alt="Toy Story">
            <img class="poster" src="../assets/poster-toy-story.jpg" alt="Toy Story">
            <div class="descricao-filme">
                <h2>Toy Story 1 (1995)</h2>
                <p class="genero"><b>Gênero:</b> Animação / Aventura</p>
                <p>Woody vê sua posição como brinquedo favorito ameaçada pela chegada de Buzz Lightyear. A rivalidade vira amizade durante uma jornada para voltarem ao dono. O filme fala sobre ciúme, mudança e lealdade.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 53 ORDER BY id DESC");
