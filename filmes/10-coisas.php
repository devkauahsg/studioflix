...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: 10-coisas.php?msg=enviado");
        exit();
    } else {
...
<head>
    ...
    <title>10 Coisas que Odeio em Você</title>
</head>
<body>
    <header class="header">
        <nav class="nav">
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-10-coisas.jpg" alt="10 Coisas que Odeio em Você">
            <img class="poster" src="../assets/poster-10-coisas.jpg" alt="10 Coisas que Odeio em Você">
            <div class="descricao-filme">
                <h2>10 Coisas que Odeio em Você (1999)</h2>
                <p class="genero"><b>Gênero:</b> Romance / Comédia</p>
                <p>Kat é independente e difícil de lidar, e Patrick é pago para conquistá-la. O romance inesperado traz reflexões sobre confiança, medo e vulnerabilidade emocional, em um clima leve e divertido.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 24 ORDER BY id DESC");
