...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: matrix.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-matrix.jpeg" alt="Matrix">
            <img class="poster" src="../assets/poster-matrix.jpg" alt="Matrix">
            <div class="descricao-filme">
                <h2>Matrix (1999)</h2>
                <p class="genero"><b>Gênero:</b> Ficção científica</p>
                <p>Neo, um hacker, descobre que o mundo real é uma simulação chamada Matrix, criada por máquinas para controlar os humanos. Com Morpheus e Trinity, ele treina para se tornar “O Escolhido”, capaz de manipular as regras da realidade e liderar a resistência. O filme mistura filosofia, ação e questionamentos sobre a percepção da realidade, levantando dúvidas sobre liberdade e controle.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 8 ORDER BY id DESC");
