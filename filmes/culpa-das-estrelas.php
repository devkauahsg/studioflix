...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: culpa-das-estrelas.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-a-culpa-e-das-estrelas.jpg" alt="A Culpa é das Estrelas">
            <img class="poster" src="../assets/poster-culpa-das-estrelas.jpg" alt="A Culpa é das Estrelas">
            <div class="descricao-filme">
                <h2>A Culpa é das Estrelas (2014)</h2>
                <p class="genero"><b>Gênero:</b> Romance</p>
                <p>Hazel e Gus, jovens com câncer, vivem um romance profundo que os faz encarar a finitude da vida e o significado do amor verdadeiro.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 44 ORDER BY id DESC");
