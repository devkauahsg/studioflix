...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: o-auto-da-compadecida.php?msg=enviado");
        exit();
    } else {
...
<head>
    ...
    <title>O Auto da Compadecida</title>
</head>
<body>
    <header class="header">
        <nav class="nav">
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-auto-da-compadecida.jpg" alt="O Auto da Compadecida">
            <img class="poster" src="../assets/poster-auto-da-compadecida.jpg" alt="O Auto da Compadecida">
            <div class="descricao-filme">
                <h2>O Auto da Compadecida (2000)</h2>
                <p class="genero"><b>Gênero:</b> Comédia / Aventura</p>
                <p>João Grilo e Chicó vivem situações absurdas e humorísticas no sertão. Com críticas sociais e muito humor, o filme mistura religiosidade, pobreza e esperteza popular.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 32 ORDER BY id DESC");
