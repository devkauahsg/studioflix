...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: de-volta-para-o-futuro.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-de-volta-para-o-futuro.jpg" alt="De Volta para o Futuro">
            <img class="poster" src="../assets/poster-de-volta-para-o-futuro.jpg" alt="De Volta para o Futuro">
            <div class="descricao-filme">
                <h2>De Volta para o Futuro (1985)</h2>
                <p class="genero"><b>Gênero:</b> Ficção científica</p>
                <p>Marty McFly viaja acidentalmente para 1955 e precisa garantir que seus pais se apaixonem para evitar apagar sua própria existência. A trama mistura humor, ficção científica e dilemas do tempo.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 54 ORDER BY id DESC");
