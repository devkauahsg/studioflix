...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: a-origem.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-aorigem.jpg" alt="A origem">
            <img class="poster" src="../assets/poster-aorigem.jpg" alt="A origem">
            <div class="descricao-filme">
                <h2>A Origem (2010)</h2>
                <p class="genero"><b>Gênero:</b> Ficção científica / Suspense</p>
                <p>Dominic Cobb é especialista em invadir sonhos para roubar segredos. Ele recebe a missão inversa: implantar uma ideia — a chamada "inception". Isso o leva a construir sonhos dentro de sonhos, enfrentando projeções perigosas e memórias traumáticas de sua esposa. O filme explora o subconsciente humano, culpa, a linha entre o real e o ilusório, e o poder das ideias.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 9 ORDER BY id DESC");
