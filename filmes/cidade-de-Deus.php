...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: cidade-de-deus.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-cidade-de-deus.jpg" alt="Cidade de Deus">
            <img class="poster" src="../assets/poster-cidade-de-deus.jpg" alt="Cidade de Deus">
            <div class="descricao-filme">
                <h2>Cidade de Deus (2002)</h2>
                <p class="genero"><b>Gênero:</b> Drama / Crime</p>
                <p>Buscapé cresce em uma favela violenta enquanto tenta fugir do crime e se tornar fotógrafo. A narrativa mostra como o ambiente molda vidas e destinos.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 48 ORDER BY id DESC");
