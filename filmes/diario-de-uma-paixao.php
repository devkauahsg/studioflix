...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: diario-de-uma-paixao.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-diario-de-uma-paixao.jpg" alt="Diário de Uma Paixão">
            <img class="poster" src="../assets/poster-diario-de-uma-paixao.jpg" alt="Diário de Uma Paixão">
            <div class="descricao-filme">
                <h2>Diário de uma Paixão (2004)</h2>
                <p class="genero"><b>Gênero:</b> Romance</p>
                <p>Noah e Allie vivem um amor intenso marcado por diferenças sociais e separações. Anos depois, ele relembra a história para ela, que sofre de Alzheimer. Um romance sobre memória, destino e amor duradouro.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 49 ORDER BY id DESC");
