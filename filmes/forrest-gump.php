...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: forrest-gump.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-forrest-gump.jpeg" alt="Forrest Gump">
            <img class="poster" src="../assets/poster-forrest-gump.jpg" alt="Forrest Gump">
            <div class="descricao-filme">
                <h2>Forrest Gump (1994)</h2>
                <p class="genero"><b>Gênero:</b> Drama / Romance</p>
                <p>Forrest, um homem com inocência e simplicidade únicas, vive momentos importantes da história dos EUA sem perceber sua grande relevância. Enquanto busca superar desafios pessoais, reencontra sempre seu amor de infância, Jenny, que segue uma vida turbulenta e oposta à dele. O filme mostra como a bondade, o acaso e a persistência podem transformar destinos, fazendo de Forrest um símbolo de como pequenas escolhas podem gerar grandes mudanças.
                Curiosidade: Tom Hanks recusou salário fixo e preferiu porcentagem do lucro — ficou milionário.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 3 ORDER BY id DESC");
