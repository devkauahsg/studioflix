...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: 300.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-300.jpg" alt="300">
            <img class="poster" src="../assets/poster-300.jpg" alt="300">
            <div class="descricao-filme">
                <h2>300 (2006)</h2>
                <p class="genero"><b>Gênero:</b> Ação / Épico</p>
                <p>O rei Leônidas lidera 300 espartanos contra o gigantesco exército persa. A narrativa exagerada inspira coragem, honra e resistência contra a tirania.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 43 ORDER BY id DESC");
