...
if (isset($_POST['comentario']) && $_POST['comentario'] !== "") {
    ...
    if ($conn->query($query)) {
        header("Location: senhor-dos-aneis.php?msg=enviado");
        exit();
    } else {
...
<body>
    ...
    <main>
        <div class="filme">
            <img class="banner" src="../assets/banner-senhordosaneis.jpg" alt="Senhor dos Anéis">
            <img class="poster" src="../assets/poster-senhordosaneis-retorno.jpg" alt="Senhor dos Anéis">
            <div class="descricao-filme">
                <h2>O Senhor dos Anéis: O Retorno do Rei (2003)</h2>
                <p class="genero"><b>Gênero:</b> Fantasia</p>
                <p>Na conclusão da saga, Frodo e Sam se aproximam de Mordor para destruir o Um Anel, enquanto Aragorn assume seu destino como rei e lidera exércitos contra Sauron. O filme apresenta guerras épicas, decisões difíceis, sacrifícios pessoais e o ápice da jornada dos personagens. É uma celebração da amizade, da coragem e do peso da responsabilidade, encerrando de forma grandiosa a trilogia.</p>
            </div>
            ...
            <div class="lista-comentarios">
                <?php
                $lista = $conn->query("SELECT id, comentario, data_hora FROM comentarios WHERE id_filmes = 7 ORDER BY id DESC");
